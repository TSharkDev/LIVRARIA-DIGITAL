    ...
    <div>
      ...
      <div className="contact--home">
        <div className="contact--container">
          <h3 className="contact--title">Abel sannts ao seu serviço!</h3>
          <form
      ...
      <div className="information--card">
        <h2 className="information--card--title">Detalhes de contato</h2>
        <p className="information--para">E-mail: abelsouza2002@gmail.com <br /> 
        Com sede na Bahia</p>
        <div>
      ...
      <div className="copyright--card">
        ...
        Todas as fotos e e-books apresentados em meu site foram obtidos
          ...
          para fins informativos e educacionais em meu site. Eu sou
          grato aos criadores originais por compartilharem seu trabalho on-line, e eu
          ...
          foram violadas, por favor entre em contato comigo para que eu possa resolver imediatamente
          a preocupação.
        </p>
        <div>
